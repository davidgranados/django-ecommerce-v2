# Generated by Django 3.2.8 on 2022-01-15 17:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ProductInventoryProductAttributeValue',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attribute_value', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='inventory.productattributevalue')),
                ('product_inventory', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='inventory.productinventory')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through='inventory.ProductInventoryProductAttributeValue', to='inventory.ProductAttributeValue'),
        ),
        migrations.AddField(
            model_name='productinventory',
            name='brand',
