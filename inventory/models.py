...
class ProductInventoryProductAttributeValue(models.Model):
    """
    ...
    class Meta:
        unique_together = (("attribute_value", "product_inventory"),)
...
class ProductInventory(models.Model):
    ...
    attribute_values = models.ManyToManyField(
        ProductAttributeValue,
        through="ProductInventoryProductAttributeValue",
    )
    is_active = models.BooleanField(
        default=True,
        verbose_name=_("product visibility"),
