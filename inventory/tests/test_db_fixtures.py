...
@pytest.mark.db_fixture
@pytest.mark.parametrize(
    "id, web_id, name, slug, description, created_at, updated_at",
    [
        (
            1,
            "45425810",
...
def test_inventory_db_product_db_fixture(
    db,
    django_db_setup,
    id,
    web_id,
...
def test_inventory_db_product_inventory_db_fixture(
    db,
    db_fixture_setup,
    id,
    sku,
...
def test_inventory_db_media_db_fixture(
    db,
    db_fixture_setup,
    id,
    product_inventory,
...
def test_inventory_db_stock_db_fixture(
    db,
    db_fixture_setup,
    id,
    product_inventory,
...
def test_inventory_db_product_attribute_db_fixture(
...
def test_inventory_db_product_attribute_insert_data(db, product_attribute_factory):
    ...
    assert new_attribute.name == "product attribute name 0"
    assert new_attribute.description == "product attribute description 0"
